...
// source: furya/cwhooks/v1/cwhooks.proto
...
func init() {
	proto.RegisterType((*Contract)(nil), "furya.cwhooks.v1.Contract")
}

func init() { proto.RegisterFile("furya/cwhooks/v1/cwhooks.proto", fileDescriptor_4ab9a924dd50ee7b) }
