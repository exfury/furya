...
// source: furya/cwhooks/v1/query.proto
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "furya.cwhooks.v1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "furya.cwhooks.v1.QueryParamsResponse")
	proto.RegisterType((*QueryStakingContractsRequest)(nil), "furya.cwhooks.v1.QueryStakingContractsRequest")
	proto.RegisterType((*QueryStakingContractsResponse)(nil), "furya.cwhooks.v1.QueryStakingContractsResponse")
	proto.RegisterType((*QueryGovernanceContractsRequest)(nil), "furya.cwhooks.v1.QueryGovernanceContractsRequest")
	proto.RegisterType((*QueryGovernanceContractsResponse)(nil), "furya.cwhooks.v1.QueryGovernanceContractsResponse")
}

func init() { proto.RegisterFile("furya/cwhooks/v1/query.proto", fileDescriptor_c08b0c5bc2d2dc51) }
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.cwhooks.v1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) StakingContracts(ctx context.Context, in *QueryStakingContractsRequest, opts ...grpc.CallOption) (*QueryStakingContractsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.cwhooks.v1.Query/StakingContracts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GovernanceContracts(ctx context.Context, in *QueryGovernanceContractsRequest, opts ...grpc.CallOption) (*QueryGovernanceContractsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.cwhooks.v1.Query/GovernanceContracts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.cwhooks.v1.Query/Params",
	}
...
func _Query_StakingContracts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.cwhooks.v1.Query/StakingContracts",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_GovernanceContracts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.cwhooks.v1.Query/GovernanceContracts",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furya.cwhooks.v1.Query",
	...
	Metadata: "furya/cwhooks/v1/query.proto",
}
