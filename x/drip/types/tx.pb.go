...
func init() {
	proto.RegisterType((*MsgDistributeTokens)(nil), "furya.drip.v1.MsgDistributeTokens")
	proto.RegisterType((*MsgDistributeTokensResponse)(nil), "furya.drip.v1.MsgDistributeTokensResponse")
	proto.RegisterType((*MsgUpdateParams)(nil), "furya.drip.v1.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "furya.drip.v1.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("furya/drip/v1/tx.proto", fileDescriptor_73c0f1d75f17f4bc) }
...
func (c *msgClient) DistributeTokens(ctx context.Context, in *MsgDistributeTokens, opts ...grpc.CallOption) (*MsgDistributeTokensResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.drip.v1.Msg/DistributeTokens", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.drip.v1.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_DistributeTokens_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.drip.v1.Msg/DistributeTokens",
	}
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.drip.v1.Msg/UpdateParams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "furya/drip/v1/tx.proto",
}
