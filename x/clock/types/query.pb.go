...
// source: furya/clock/v1/query.proto
...
func init() {
	proto.RegisterType((*QueryClockContracts)(nil), "furya.clock.v1.QueryClockContracts")
	proto.RegisterType((*QueryClockContractsResponse)(nil), "furya.clock.v1.QueryClockContractsResponse")
	proto.RegisterType((*QueryParamsRequest)(nil), "furya.clock.v1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "furya.clock.v1.QueryParamsResponse")
}

func init() { proto.RegisterFile("furya/clock/v1/query.proto", fileDescriptor_7da208f579d775c8) }
...
func (c *queryClient) ClockContracts(ctx context.Context, in *QueryClockContracts, opts ...grpc.CallOption) (*QueryClockContractsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.clock.v1.Query/ClockContracts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.clock.v1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_ClockContracts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.clock.v1.Query/ClockContracts",
	}
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.clock.v1.Query/Params",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furya.clock.v1.Query",
	...
	Metadata: "furya/clock/v1/query.proto",
}
