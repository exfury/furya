...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "furya.mint.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "furya.mint.QueryParamsResponse")
	proto.RegisterType((*QueryInflationRequest)(nil), "furya.mint.QueryInflationRequest")
	proto.RegisterType((*QueryInflationResponse)(nil), "furya.mint.QueryInflationResponse")
	proto.RegisterType((*QueryAnnualProvisionsRequest)(nil), "furya.mint.QueryAnnualProvisionsRequest")
	proto.RegisterType((*QueryAnnualProvisionsResponse)(nil), "furya.mint.QueryAnnualProvisionsResponse")
	proto.RegisterType((*QueryTargetSupplyRequest)(nil), "furya.mint.QueryTargetSupplyRequest")
	proto.RegisterType((*QueryTargetSupplyResponse)(nil), "furya.mint.QueryTargetSupplyResponse")
}

func init() { proto.RegisterFile("furya/mint/query.proto", fileDescriptor_a6f0d4f2a25816bd) }
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.mint.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Inflation(ctx context.Context, in *QueryInflationRequest, opts ...grpc.CallOption) (*QueryInflationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.mint.Query/Inflation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AnnualProvisions(ctx context.Context, in *QueryAnnualProvisionsRequest, opts ...grpc.CallOption) (*QueryAnnualProvisionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.mint.Query/AnnualProvisions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) TargetSupply(ctx context.Context, in *QueryTargetSupplyRequest, opts ...grpc.CallOption) (*QueryTargetSupplyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.mint.Query/TargetSupply", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.mint.Query/Params",
	}
...
func _Query_Inflation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.mint.Query/Inflation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_AnnualProvisions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.mint.Query/AnnualProvisions",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_TargetSupply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.mint.Query/TargetSupply",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
