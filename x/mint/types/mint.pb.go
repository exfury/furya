...
func init() {
	proto.RegisterType((*Minter)(nil), "furya.mint.Minter")
	proto.RegisterType((*Params)(nil), "furya.mint.Params")
}

func init() { proto.RegisterFile("furya/mint/mint.proto", fileDescriptor_e0bccce3b583aa44) }
