...
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	rootCmd := &cobra.Command{
		Use:   version.AppName,
		Short: "Furya Smart Contract Zone",
		PersistentPreRunE: func(cmd *cobra.Command, _ []string) error {
			...
			os.Setenv("FURYAD_CONSENSUS_TIMEOUT_COMMIT", cast.ToString(timeoutCommit))
...
func initAppConfig() (string, interface{}) {
	...
	// srvCfg.MinGasPrices = "0ufury,0ufuryx" // GlobalFee handles
