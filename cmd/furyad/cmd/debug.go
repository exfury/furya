...
// get cmd to convert any bech32 address to a furya prefix.
func ConvertBech32Cmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "bech32-convert [bech32 string]",
		Short: "Convert any bech32 string to the furya prefix",
		Long: `Convert any bech32 string to the furya prefix
Especially useful for converting cosmos addresses to furya addresses
Example:
	furyad bech32-convert furya1ey69r37gfxvxg62sh4r0ktpuc46pzjrm5cxnjg -p osmo
	`,
	...
	cmd.Flags().StringP(flagBech32Prefix, "p", "furya", "Bech32 Prefix to encode to")
