...
Most of our validator communications are done on the [Furya Discord](https://discord.gg/Furya). You should join, and change your server name to `nick | validator-name`, then ask a mod for permission to see the private validator channels.
